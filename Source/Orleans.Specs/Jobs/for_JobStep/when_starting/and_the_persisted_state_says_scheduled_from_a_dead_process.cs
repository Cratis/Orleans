...
namespace Cratis.Orleans.Jobs.for_JobStep.when_starting;

/// <summary>
/// The wedge this guards against: a step that was Scheduled when its process died must start over on
/// the next Start, not answer AlreadyStarted - nothing is running in the fresh activation, so
/// AlreadyStarted leaves the step Scheduled forever and its job permanently Running.
/// </summary>
