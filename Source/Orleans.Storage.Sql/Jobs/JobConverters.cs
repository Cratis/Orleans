...
public static class JobConverters
{
    ...
    /// <param name="options">The <see cref="JsonSerializerOptions"/> to use for deserializing the polymorphic <c lang="csharp">JobState.Request</c>.</param>
    ...
    /// <param name="options">The <see cref="JsonSerializerOptions"/> to use for serializing the polymorphic <c lang="csharp">JobState.Request</c>.</param>
